<template>
  <div style="height:100%">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>临牌管理</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="card">
      <p class="title">
        <span>临牌管理</span>
        <el-button size="mini" @click="addOrder">添加临牌</el-button>
      </p>
      <!-- 列表 -->
      <el-table
        :data="tableData"
      ...
      >
        <el-table-column label="">
          ...
          <el-table-column prop="id" label="临牌ID" width="80px"></el-table-column>
          ...
          <el-table-column prop="cart_name" label="车辆名称" width="220px"></el-table-column>
        </el-table-column>
...
export default {
  ...
  methods: {
    async getList() {
      ...
      await this.$axios.post(url.getTemporaryu, data).then(res => {
    ...
    delBusiness(row) {
      ...
      this.$confirm("确定删除吗？", "提示", {
        ...
        .then(() => {
          this.$axios.post(url.delTemporary, data).then(res => {
            if (res.data.status == 1) {
