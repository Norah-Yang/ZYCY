<template>
  <div style="height:100%">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>铭牌管理</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="card">
      <p class="title">
        <span>铭牌管理</span>
        <el-button size="mini" @click="addOrder">添加铭牌</el-button>
      </p>
      <!-- 列表 -->
      <el-table
        :data="tableData"
      ...
      >
        <el-table-column label="">
          ...
          <el-table-column prop="id" label="铭牌ID" width="80px"></el-table-column>
...
export default {
  ...
  methods: {
    async getList() {
      ...
      await this.$axios.post(url.getNameplate, data).then(res => {
    ...
    delBusiness(row) {
      ...
      this.$confirm("确定删除吗？", "提示", {
        ...
        .then(() => {
          this.$axios.post(url.delNameplate, data).then(res => {
            if (res.data.status == 1) {
