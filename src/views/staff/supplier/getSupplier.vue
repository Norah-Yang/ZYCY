<template>
  <div style="height:100%">
    ...
    <div class="card">
      <p class="title">
        <span>供应商列表</span>
        <el-button size="mini" @click="addOrder">添加供应商</el-button>
      </p>
      <!-- 列表 -->
      <el-table
        :data="tableData"
      ...
      >
        <el-table-column label="">
          ...
          <el-table-column prop="id" label="供应商ID" width="100px"></el-table-column>
          <el-table-column prop="name" label="供应商名称" width="250px"></el-table-column>
          <el-table-column prop="title" label="供应商简称" width="150px"></el-table-column>
          ...
          <el-table-column prop="contact" label="联系人" width="160px"></el-table-column>
        </el-table-column>
...
export default {
  ...
  methods: {
    async getList() {
      ...
      await this.$axios.post(url.gatSupplier, data).then(res => {
    ...
    delBusiness(row) {
      ...
      this.$confirm("确定删除吗？", "提示", {
        ...
        .then(() => {
          this.$axios.post(url.delSupplier, data).then(res => {
            if (res.data.status == 1) {
