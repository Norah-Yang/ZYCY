<template>
  <div style="height:100%">
    ...
    <div class="card">
      <p class="title">
        <span>客户列表</span>
        <el-button size="mini" @click="addOrder">添加客户</el-button>
      </p>
      <!-- 列表 -->
      <el-table
        :data="tableData"
      ...
      >
        <el-table-column label="">
          ...
          <el-table-column prop="id" label="客户ID" width="80px"></el-table-column>
          <el-table-column prop="name" label="客户名称" width="250px"></el-table-column>
          <el-table-column prop="title" label="客户简称" width="150px"></el-table-column>
          ...
          <el-table-column prop="city" label="城市" width="160px"></el-table-column>
        </el-table-column>
...
export default {
  ...
  methods: {
    async getList() {
      ...
      await this.$axios.post(url.getCustomer, data).then(res => {
