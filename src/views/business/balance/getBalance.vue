<template>
  <div style="height:100%">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>尾款列表</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="card">
      <p class="title">
        <span>尾款列表</span>
        <el-button size="mini" @click="addOrder">添加尾款</el-button>
      </p>
      <!-- 列表 -->
      <el-table
        :data="tableData"
      ...
      >
        <el-table-column label="">
          ...
          <el-table-column prop="id" label="尾款ID" width="80px"></el-table-column>
...
export default {
  ...
  methods: {
    async getList() {
      ...
      await this.$axios.post(url.balance, data).then(res => {
    ...
    delBusiness(row) {
      ...
      this.$confirm("确定删除吗？", "提示", {
        ...
        .then(() => {
          this.$axios.post(url.delBalance, data).then(res => {
            if (res.data.status == 1) {
